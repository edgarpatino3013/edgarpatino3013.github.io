  ...
  return (
    <section className="bg-gray-900 text-white py-20 px-6 md:px-20">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-center font-semibold mb-10">I'll get back to you very soon!</p>
        ...
        <form ref={form} onSubmit={sendEmail} className="space-y-6">
          ...
          <button
            type="submit"
            className="bg-blue-500 hover:bg-green-600 text-white font-semibold px-8 py-3 rounded-lg transition"
          >
            Send Message
          </button>
        </form>
